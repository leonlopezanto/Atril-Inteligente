...
$jscomp.polyfill = function(m, x, r, t) {
    if (x) {
        ...
        t = r[m];
        x = x(t);
        x != t && null != x && $jscomp.defineProperty(r, m, {
            configurable: !0,
            writable: !0,
            value: x
        })
...
(function() {
    ...
    function J(a, b) {
        ...
        if (Array.isArray(a))
            for (d =
                0; d < a.length; ++d) d in a && c.push([d, a[d]]);
        else
    ...
    function N(a, b, c) {
        var d = 0,
            e, f, g = b[a];
        f = g.tup.indexOf("start"); - 1 < f && g.tup.splice(f, 1);
        var h = a;
    ...
    function Y(a, b) {
        ...
        for (var c = 0, d = [], e = [], f = 0; f < a.length; ++f) {
            ...
            if (g instanceof C) g.tijd < c && (g.tijd = c), d.push(g), c = g.tijd;
            else {
                if (g.tijd < c) {
                    if ("z" == g.ns[0]) continue;
                    var h = d[d.length - 1];
                    if (h.tijd <= g.tijd)
                        if ("z" == h.ns[0]) h.dur = g.tijd - h.tijd, 0 == h.dur && d.pop(), u("overlap in part %d, measure %d: rest shortened",
                            [b.ixp + 1, b.ixm + 1]);
                        else {
                ...
                d.push(g);
                if (g instanceof A)
                    if (c = g.ns[0], "x" == c || "z" == c) e.push(d.length - 1);
                    else if (e.length) {
                    if (g.beam && !g.grace)
                        for (c = 0; c < e.length; ++c) d[e[c]].beam = g.beam;
                    e = []
                }
                c = g.tijd + g.dur
            }
    ...
    function P(a, b, c, d, e, f) {
        if ("name_tuple" == a[0]) d = d.shift(), b[0] && (a[1] = b[0] + ":" + a[1], a[2] = b[1] + ":" + a[2]), e.push(a), f.push.apply(f, O(d));
        else if (2 == a.length && "name_tuple" == a[0][0]) d = d.shift(), c = ["name_tuple", "", ""], c[1] =
            a[0][1] + ":" + a[1][2], c[2] = a[0][2] + ":" + a[1][3], e.push(c), f.push.apply(f, O(d));
        else {
            var g, h, k;
            k = a[a.length - 1];
            b = k[0];
    ...
    function ba(a) {
        ...
        a = a.split("\n");
        for (d = 0; d < a.length; ++d)
            if (e = a[d], 0 <= e.indexOf("I:percmap") && (e = e.split(" ").map(function(a) {
                    return a.trim()
        ...
        function(a, b, c, d, e) {
            ...
            for (q in this.clefs) {
                ...
                for (n = 0; n < p.length; ++n)
                    if (h = p[n].nt, l = p[n].step, b = p[n].midi, (k = p[n].nhd) || (k = "normal"), M(h) != b || h != l) 0 < this.volpan && f.push("%%MIDI drummap " + h + " " + b + "\n"), f.push("I:percmap " +
    ...
    v.prototype.tabnote = function(a, b, c, d, e) {
        ...
        for (l = 0; 4 > l; ++l) {
            ...
            h = c; - 1 < ["^B", "^^B"].indexOf(f) && --h; - 1 < ["_C", "__C"].indexOf(f) && (h += 1);
    ...
    v.prototype.doNote = function(a) {
        ...
        var k = 0 == (this.curClef && this.curClef[this.curStf[c]] || "").indexOf("tab"),
            l = a.find("notations");
        ...
        for (f = k = 0; f < e.length; ++f) {
            var l = $(e[f]),
                p = parseInt((l.attr("number") || "1").replace(/^.*verse/, ""));
            0 == p ? p = k + 1 : k = p;
            b.lyrs[p] =
                aa(l)
        }
    ...
    v.prototype.doPartList = function(a) {
        ...
        for (b = 0; b < e.length; ++b) {
            ...
            for (c = 0; c < g.length; ++c) {
                ...
                d = 1 * k[3]; - 90 <= d && 90 >= d && (d = (d + 90) / 180 * 127);
    ...
    v.prototype.addStaffMap = function(a) {
        var b, c, d, e, f, g, h, k = [],
            l = Object.keys(this.stfMap).sort();
        for (c = 0; c < l.length; ++c) {
            ...
            if (g.length)
                for (k.push(g), e = (f in this.clefMap) ? this.clefMap[f] : "treble", b = 0; b < g.length; ++b) d = g[b], f = "", 0 == e.indexOf("tab") && (h[b] && 0 > e.indexOf("nostems") && (f = " nostems"), this.diafret && 0 > e.indexOf("diafret") && (f += " diafret")), w.clefs[d] = e + f
        }
        this.gStfMap.push(k)
    };
    v.prototype.addMidiMap = function(a, b) {
        ...
        for (g in b) e = Object.keys(this.drumNotes).sort().filter(function(a) {
            ...
            return {
                nt: a.split(";")[1],
                step: l.drumNotes[a][0],
                midi: l.drumNotes[a][1],
                nhd: l.drumNotes[a][2]
            }
